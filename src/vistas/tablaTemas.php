...
<nav id="nav" class="navbar navbar-black navbar-expand-md navbar bg-color">
    ...
    <h2 class="text-center mb-5">Tabla temas</h2>
    <div class="mt-3">
                    <?php
                      if (isset($_GET['msj'])) {
  ...
  <tbody>
    <?php
      $resul=Tema::obtenerTemas($conectar);
    ...
    <tr>
      ...
      <button data-id="<?php echo $tema->getId(); ?>" id="btnEditar" type="button" class="btn btn-primary btnEditar" data-bs-toggle="modal" data-bs-target="#exampleModal">
      Editar
      </button>
      <a href="eliminar-temas/<?php echo $tema->getId(); ?>" type="button" class="btn btn-primary">Eliminar</a>
      </div> 
      </td>
    </tr>
    <?php } ?>
...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form action="editar-temas" method="post">
