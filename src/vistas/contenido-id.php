...
$contenido=new Contenido();
  $id=$respuesta['id'];
  $resul=Contenido::obtenerVistas($conectar,$id);
  $registro = $resul[0];
  $vista = $registro['vistas'];

  if (isset($vista)) {
    $vista++;
    $nuevaVista=$vista;
    Contenido::editarVistas($conectar,$nuevaVista,$id);
  }
?>
<!DOCTYPE html>
<html lang="es">
...
<nav id="nav" class="navbar navbar-black navbar-expand-md navbar bg-color">
    ...
    <main class="container contenido">
        <?php
          $resultado=VistaContenido::obtenerContenidos($id);
        ...
        ?>
            <div class="card card-publicacion mb-5">
                <?php
   ...
   <button id="btn-subir" class="btn-subir-none">
    ...
    <footer id="footer" class="foot-ctn fixed-bottom">
    ...
    <script src="../src/assets/js/eclipseContenidoDos.js"></script>
