...
<body>
    <nav id="nav" class="navbar navbar-black navbar-expand-md navbar bg-color">
      ...
      <h2 class="text-center mb-5">Agregar Lengua</h2>
        <div class="row">
        <section class="col-sm-12 col-md-6 col-lg-6 mb-5">
                <p>En este apartado podrás añadir las lenguas para poder hacer referencia a las categorías y contenidos. Por ejemplo, si deseas añadir una categoría y/o contenido en un lenguaje que no aparece en el sistema, puedes cargarlo desde aquí.</p>

                <small>Nota: Cada lengua añadida aparecera en los demas formularios.</small>
                <br><br>
        ...
        <section class="col-sm-12 col-md-6 col-lg-6 mb-5">
        <form class="shadow-sm p-3 mb-5 bg-body-tertiary rounded" action="auth-lengua" method="post">
            <div class="mb-3">
