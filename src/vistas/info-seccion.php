      ...
      <main class="container seccion-ctn">
        <section class="row seccion">
            ...
            <div class="col-sm-12 col-md-8 col-lg-9">
                <p id="txt-eclipse" class="txt-info">
                  Ciencia abierta. Comunicación del conocimiento es una plataforma digital que tiene contenidos científicos, culturales y humanísticos, con perspectiva de género y acceso a la información dirigida a las personas hablantes de Tseltal, Tsotsil, CH'ol, Tojol-ab'al y Zoque.
