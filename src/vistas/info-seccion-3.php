...
<?php include 'navbar.php'; ?>
      ...
      <header id="header" class="header">
        ...
        <div id="header-contenido" class="header-content">
            <h1 class="text-center compromiso-social">Compromiso social</h1>
        ...
        <section class="row seccion">
          ...
          <div class="col-sm-12 col-md-8 col-lg-9">
             <p id="txt-eclipse" class="txt-info" style="padding-top:12vh; padding-bottom: 12vh;">
                Se busca el acercamiento de la información con transparencia y acceso a la información en beneficio de las comunidades en su contexto sociocultural, étnico y geográfico que conforman el Estado de Chiapas; especialmente dirigido a grupos sub-representados y vulnerables, a fin de contribuir al desarrollo municipal, estatal y regional con un enfoque nacional e internacional.
