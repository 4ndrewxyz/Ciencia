<?php
  ...
  <main class="container admin-ctn">
      <h2 class="text-center mb-5">Tabla Álbums</h2>
      <div class="mt-3">
          <?php
          if (isset($_GET['msj'])) {
                              ...
                              <tr>
                                  ...
                                  <td>
                                      <div class="btn-group" role="group" aria-label="Basic example">
                                          ...
                                          <a href="eliminar-album/<?php echo $albums->getId(); ?>" type="button" class="btn btn-primary">Eliminar</a>
                                      </div> 
                                  </td>
                              </tr>
                              <?php 
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form action="editar-albums" method="post">
